...
#    gitignore
# ###################################################################################################
bdh_module_name_root module, "gitignore",
  emit_codegen  : (root, ctx)->
    path = "#{ctx.curr_folder}/.gitignore"
    ...
    if fs.existsSync path
      ...
      if extra_line_list.length
        ...
        ctx.file_render ".gitignore", new_cont
    else
...
def "gitignore", (multi_line_str="")->
  ...
  root = project_node.tr_get "gitignore", "gitignore", "def"
  # root = mod_runner.current_runner.curr_root.tr_get "gitignore", "gitignore", "def"
  bdh_node_module_name_assign_on_call root, module, "gitignore"
